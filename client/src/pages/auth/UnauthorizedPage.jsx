      ...
      <div style={s.card}>
        ...
        <div style={s.iconWrap} aria-hidden="true">
          <svg width="56" height="56" viewBox="0 0 56 56" fill="none">
            ...
            <circle cx="28" cy="28" r="27" stroke="#ef4444" strokeWidth="1.5"
              strokeDasharray="60 110" strokeLinecap="round" />
            <path d="M28 18v14" stroke="#ef4444" strokeWidth="2.5"
              strokeLinecap="round" />
        ...
        {isAuthenticated && user && (
          <div style={s.userBadge}>
            ...
            <span style={s.userText}>
              Signed in as{" "}
              <strong style={s.userStrong}>{user.name}</strong>
              {" "}·{" "}
        ...
        <p style={s.explanation}>
          This section is restricted to a different role. If you believe this
